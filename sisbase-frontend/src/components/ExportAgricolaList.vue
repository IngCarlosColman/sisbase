    ...
    <v-card class="my-4">
      <v-card-text>
        <div class="d-flex align-center">
          <v-text-field
            v-model="searchText"
            label="Buscar por propietario, operador, departamento o ciudad..."
...
const API_BASE_URL = 'http://localhost:8000/api/exportagricola';
...
const headers = ref([
  ...
  { title: 'Gerente', key: 'gerente' },
  { title: 'Teléfono', key: 'telefono' },
  { title: 'Instalación', key: 'instalacion' },
