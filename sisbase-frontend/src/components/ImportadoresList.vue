    ...
    <v-card class="my-4">
      <v-card-text>
        <div class="d-flex align-center">
          <v-text-field
            v-model="searchText"
            label="Buscar por razón social o email..."
    ...
    <v-dialog v-model="dialog" max-width="600px">
      <v-card>
        <v-card-title class="text-h5">
          {{ isEditing ? 'Editar Importador' : 'Agregar Importador' }}
        </v-card-title>
        <v-card-text>
          <v-container>
...
const API_BASE_URL = 'http://localhost:8000/api/importadores';
...
const headers = ref([
  ...
  { title: 'Email', key: 'email', style: 'min-width: 250px; width: 250px;' },
